...
#This program find changes in the prteitn motion described by compponent 0 in J1005 upon binding of ligand csIB_Z (Inz5 bound), csIB_A(inhibitor free).
...
csIB = open_cs('cryosparc_P26_J1005_particles.cs')

csIB_Z,csIB_A = H_A(csIB)
...
plt.hist(csIB_Z['components_mode_0/value'],bins = 100, histtype = 'stepfilled',linewidth=8,ec = 'k',facecolor = 'steelblue',alpha = 0.7,density=True,label='lnz-5 bound')
plt.hist(csIB_A['components_mode_0/value'],bins = 100, histtype = 'stepfilled',linewidth=8,ec = 'k',facecolor = 'powderblue',alpha = 0.7,density=True,label='APO')
...
plt.hist(csIB['components_mode_0/value'][:],bins = 100, histtype = 'stepfilled',ec='k',linewidth=8,color = 'lightsteelblue',alpha = 1)
